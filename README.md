...
Use Logistic Regression as a baseline decision-support model for marketing outreach

Incorporate additional non-leaky campaign features to improve recall

Adjust decision thresholds based on call-center capacity

Explore resampling or cost-sensitive learning techniques

Monitor model performance over time as customer behavior changes
